...
def parse_arguments():
    ...
    parser.add_argument('--scmut_model_path', type=str, required=True,
                      help='Path to the trained scMut model .pkl file')
