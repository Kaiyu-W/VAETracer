...
def visualize_predictions(original_z_real_dict, original_zxt_dict, pred_dict, 
...
def _generate_all_umaps(real_z_dict, real_zxt_dict, split_preds,
...
def _plot_umap(real_dict, pred_dict, key, title, filename, 
              output_dir, plot_format, 
              real_times_keep=None, pred_times_keep=None):
...
def analyze_and_visualize(original_z_real_dict, original_zxt_dict, pred_dict,
...
def analyze_n_distribution(model, original_z_real_dict, split_pred_dict, 
    ...
    _plot_real_n_umap(decoder_n, original_z_real_dict, 
                     real_times_keep, args)

    if pred_times_keep:
        _plot_combined_n_umap(decoder_n, original_z_real_dict, split_pred_dict,
                            real_times_keep, pred_times_keep,
                            args)
...
def plot_distribution_comparison(real_dict, pred_dict, decoder_n, 
                               predict_time,  
                               args=None):
...
def _extract_all_z_and_n(real_dict, split_pred_dict, decoder_n, 
                        real_times_keep, pred_times_keep):  
...
def _plot_combined_n_umap(decoder_n, original_z_real_dict, split_pred_dict,
                        real_times_keep, pred_times_keep,
                        args=None):
